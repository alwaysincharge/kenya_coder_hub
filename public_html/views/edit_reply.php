...
<body onload="setInterval(replaceText1, 100)" onpageshow="setInterval(replaceText2, 100)">
            ...
            while($row = $this_reply_result->fetch_assoc()) { ?>
               ...
               <form method='post' action="<?php echo $_SESSION['url_placeholder']; ?>backend/code_edit_reply.php"  class='forum-form'>
                   
                   
                     <p class="home-head">Edit your comment.</p>
                   
                     <a href="<?php echo $_SESSION['url_placeholder']; ?>post/<?php echo $_GET['post'];  ?>" class="home-head-2">Visit related post.</a>
