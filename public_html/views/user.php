...
<div class="row" style="background: white; padding-top: 20px; width: 100%; max-width: 900px; display: table; margin: 0 auto; padding: 20px;">   
            ...
            ?>
               ...
               <div class="col-xs-6">
                   ...
                   <img  src="<?php echo $_SESSION['url_placeholder']; ?>backend/<?php echo $details['img_path'];  ?>" width="170" style="border-radius: 5px; margin-top: 30px; display: table; margin: 0 auto; " />
                ...
                <div class="col-xs-6">
                    ...
                    <p class="email-user"><?php echo $details['email'];   ?></p>
                     ...
                     <button name="submit" class="btn" style="font-family: georgia;"><a href="<?php echo $_SESSION['url_placeholder']; ?>views/editprofile.php">Edit Profile</a></button>   
                     ...
                     <button name="submit" class="btn" style="font-family: georgia;"><a href="<?php echo $_SESSION['url_placeholder']; ?>views/messages.php?usersid=<?php echo $details['id']; ?>">Send Message</a></button>   
