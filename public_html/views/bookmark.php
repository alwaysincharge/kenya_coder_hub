...
<div class="row" style="width: 100%; max-width: 1300px; display: table; margin: 0 auto;">
  ...
  <p class="home-head">Your saved posts.</p>
            ...
            <div class="row single-post">
                ...
                <a href="<?php echo $_SESSION['url_placeholder']; ?>post/<?php echo $row['id']; ?>" class="post-title"> <?php echo substr($row['title'], 0, 80); if (strlen($row['title']) > 70) {echo "...";}  ?></a>
                ...
                <a href="<?php echo $_SESSION['url_placeholder']; ?>backend/delete_bookmark.php?forumid=<?php echo $row['id']; ?>" class="form-call">Unsave</a> //
