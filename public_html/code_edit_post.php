...
if (isset($_POST['submit']))  {
 ...
 check_lenght_3($body_input, 0, 1000, 'The maximum number of characters for each field is title: 300, body: 1000, code: 1000. ', 'edit_post.php?forum=' . $id_post);    
    
 check_lenght_3($code_input, 0, 1000, 'The maximum number of characters for each field is title: 300, body: 1000, code: 1000. ', 'edit_post.php?forum=' . $id_post); 
