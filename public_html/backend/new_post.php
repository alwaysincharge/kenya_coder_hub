...
if (isset($_POST['submit']))  {
 ...
 check_emptiness($title_input, $_SESSION['url_placeholder'] . 'write', 'The body or title field cannot be empty. Please try again.');
    
 check_emptiness($body_input, $_SESSION['url_placeholder'] . 'write', 'The body or title field cannot be empty. Please try again.');
 ...
 redirect_to($_SESSION['url_placeholder'] . 'post/' . $last_id);
