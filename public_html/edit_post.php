            ...
            while($row = $this_post_result->fetch_assoc()) { ?>
               ...
               <form method='post' action="code_edit_post.php"  class='forum-form'>
                    ...
                    <p class="home-head">Edit your post.</p>
                     ...
                     <textarea maxlength="500" style="height: 150px;" placeholder='Do you have a question, job or story to share?' name="body" class="forum-details"><?php echo $row["body"];  ?></textarea>
                   
                     <div>
                       
                     <textarea maxlength="500" style="height: 150px;" placeholder='Paste related code here.' name="code" class="toggle forum-details"><?php echo $row["code"];  ?></textarea>
                         
                         
                     <input maxlength="500" type="hidden" name="id" class="toggle forum-details" value="<?php echo $_GET["forum"];  ?>">
                    
                               
                     <textarea maxlength="500" style="height: 80px;" placeholder="Title of your post." name="title" class="forum-title"><?php echo $row["title"];  ?></textarea> <br>
