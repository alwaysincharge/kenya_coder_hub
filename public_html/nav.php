        ...
        <nav style="background: #fff; " ><br>
            ...
            <div class="dropdown">
              ...
              <img src="/fridaycamp/public_html/male.png" height="40" width="40" style="margin-left: 10px; border-radius: 5px; font-family: Josefin Slab;" />
             
            <div class="dropdown-content" style="font-weight: bolder; ">
                
                            <p style=" font-family: Josefin Slab;"></p>
                
                            <a href="profile.php?person=<?php echo $_SESSION['admin_id']; ?>" style="font-family: Josefin Slab;">View Profile</a><br>
                                 <a href="mine.php" style="font-family: Josefin Slab;">My Stuff</a><br>
                
                
                <a href="saves.php" style="font-family: Josefin Slab;">Saved Posts</a><br>
                
                            <a href="editpic.php" style="font-family: Josefin Slab;">Edit Profile Picture</a><br>

                            <a href="makeprofile.php" style="font-family: Josefin Slab;">Edit Info</a><br>
